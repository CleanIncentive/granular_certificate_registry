        ...
        return (
          <>
            ...
            <CertificateActionBar
              onActionClick={handleCertificateActionClick}
            />
            <br />
          ...
          {selectedAccount && (
            <div>
              <Account
                ...
                certificates={selectedAccount.certificates}
              />
              <Menu
                mode="horizontal"
                selectedKeys={[selectedView]}
                onClick={({ key }) => handleViewClick(key)}
              >
